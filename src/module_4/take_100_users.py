...
df = feature_frame[feature_frame["outcome"] == 1][
    ["user_id", "ordered_before", "global_popularity", "abandoned_before"]
].sample(20)
...
output_folder = Path(
    "D:/Users/maick/Desktop/Codigos/Data-science-applied/future_purchase_prediction/model_no_lineal"
)
